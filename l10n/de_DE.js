OC.L10N.register(
    ...
    "View and share albums made by the [Souvenirs android application](https://github.com/zorgluf/souvenirs-android).\n    \\nThis application is just a viewer. No album creation or edition features are available for the moment. You will need to create albums using the android app and sync them to your nextcloud server." : "Zeigen Sie Alben an und teilen diese, die von der [Souvenirs-Android-Anwendung] (https://github.com/zorgluf/souvenirs-android) erstellt wurden.\n    \\nDiese Anwendung ist nur ein Betrachter. Derzeit sind keine Funktionen zum Erstellen oder Bearbeiten von Alben verfügbar. Sie müssen Alben mit der Android-App erstellen und sie mit Ihrem Nextcloud-Server synchronisieren.",
    "Loading album list..." : "Albenliste wird geladen...",
    "No album available. You will need to upload them from the android app Souvenirs (https://github.com/zorgluf/souvenirs-android)." : "Kein Album verfügbar. Sie müssen diese von der Android-App Souvenirs (https://github.com/zorgluf/souvenirs-android) hochladen",
